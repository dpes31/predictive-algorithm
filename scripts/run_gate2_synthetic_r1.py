#!/usr/bin/env python3
"""Run Gate 2-3R synthetic experiments."""
...
from simulation.report_builder_r1 import build_markdown_report
...
def main() -> int:
    ...
    parser.add_argument("--json-output", default="reports/gate2_3r_synthetic_summary.json")
    parser.add_argument("--markdown-output", default="reports/gate2_3r_synthetic_summary.md")
    ...
    def progress(message: str) -> None:
        print(f"[gate2-3R] {message}", file=sys.stderr, flush=True)
